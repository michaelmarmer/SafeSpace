    ...
    <div class="modal fade"  data-backdrop="static"  id="myModal" role="dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            <form action="account_recovery_password2_submit.php" method="post" class="form-horizontal" role="form">
              <div class="form-group">
                <label class="control-label col-sm-2" id="labels" for="username">New Password</label>
                <div class="col-sm-4">
